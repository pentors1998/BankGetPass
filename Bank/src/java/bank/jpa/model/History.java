...
public class History implements Serializable {
    ...
    public History(Account accountid ,Integer historyid, String method, int amount, Date time, int balance) {
    ...
    public String toString() {
        return "bank.jpa.model.History[ historyid=" + historyid + " ]";
    }
